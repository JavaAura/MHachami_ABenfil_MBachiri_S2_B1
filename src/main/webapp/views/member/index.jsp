                            ...
                            <c:forEach items="${model.members}" var="member">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button type="button"  data-bs-toggle="modal" data-bs-target="#deleteModal">                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 16">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form action="member?action=delete&id=${member.id}" method="post">
